...
<div class="login-box">
    ...
    <div class="card">
        <div class="card-body login-card-body">
            <p class="login-box-msg">admin@admin.com / password</p>
            <p class="login-box-msg">freelancer@freelancer.com / password</p>
            <p class="login-box-msg">user@user.com / password</p>
